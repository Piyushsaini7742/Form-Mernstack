...
const AddUser = () => {
    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-6 bg-gray-100 shadow-lg rounded-md">
            <h2 className="text-xl font-semibold text-center text-gray-700 mb-4">User Registration</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
                <input type="text" name="name" placeholder="Full Name" className="input-field" required onChange={handleChange} />
                ...
                <select name="state" className="input-field" required onChange={handleStateChange}>
                ...
                <select name="district" className="input-field" required disabled={!formData.state} onChange={handleChange}>
                ...
                <input type="text" name="rollNumber10th" placeholder="10th Roll Number" className="input-field" required onChange={handleChange} />
                <textarea name="fullAddress" placeholder="Full Address" className="input-field" required onChange={handleChange}></textarea>
                ...
                <input type="color" name="favouriteColor" className="w-full h-10 cursor-pointer" onChange={handleChange} />
                <button type="submit" className="w-full bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 transition">Register</button>
            </form>
        </div>
    );
};
